...
; now we need to reload the enemy mon pic ; CHS_Fix 07
...
.writemoves
	ld de, wMovesString ; CHS_Fix 08
	; ldh a, [hUILayoutFlags] ; CHS_Fix 08
	; set 2, a ; CHS_Fix 08
	; ldh [hUILayoutFlags], a ; CHS_Fix 08
	call PlaceString
	; ldh a, [hUILayoutFlags] ; CHS_Fix 08
	; res 2, a ; CHS_Fix 08
	; ldh [hUILayoutFlags], a ; CHS_Fix 08
...
.regularmenu
	...
	; ld b, 4
	; ld c, 14
	hlcoord 0,8 ; CHS_Fix 09
	lb bc, 8, 9 ; CHS_Fix 09
