...
IF DEF(_BLUE)
	FlowerTile1: INCBIN "gfx/tilesets/flower/flower1_b.2bpp"
	FlowerTile2: INCBIN "gfx/tilesets/flower/flower2_b.2bpp"
	FlowerTile3: INCBIN "gfx/tilesets/flower/flower3_b.2bpp"
ELSE
