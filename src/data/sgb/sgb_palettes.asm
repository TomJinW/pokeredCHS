...
; ENDC
; IF DEF(_GREEN)
; 	RGB 30,31,29, 30,30,17, 21,00,04, 10,29,03 ; PAL_LOGO1
...
; JP Logo Palettes
IF DEF(_RED)
	RGB 31,29,31, 30,30,17, 17,23,10, 14,19,29 ; PAL_LOGO1
	RGB 31,29,31, 30,30,17, 17,23,10, 21,00,04 ; PAL_LOGO2
ENDC
IF DEF(_BLUE)
	RGB 31,29,31, 30,30,17, 21,00,04, 09,16,12 ; PAL_LOGO1
	RGB 31,29,31, 30,30,17, 21,00,04, 14,19,29 ; PAL_LOGO2
ENDC
IF DEF(_GREEN)
	RGB 30,31,29, 30,30,17, 21,00,04, 14,19,29 ; PAL_LOGO1
	RGB 30,31,29, 30,30,17, 21,00,04, 11,31,03 ; PAL_LOGO2
ENDC
